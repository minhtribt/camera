...
CREATE TABLE `download` (
  ...
  `download_name` varchar(5000) COLLATE utf8_unicode_520_ci DEFAULT NULL,
  `download_content` text COLLATE utf8_unicode_520_ci,
  `download_file` varchar(5000) COLLATE utf8_unicode_520_ci DEFAULT NULL,
  `download_create_day` varchar(5000) COLLATE utf8_unicode_520_ci DEFAULT NULL,
